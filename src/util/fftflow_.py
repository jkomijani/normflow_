...
from ..lib.outer_operation import outer_arange
...
class FFTNet_(Module_):
    ...
    **CHANNELS** are removed
    ...
    def transfer(self, *, shape, scale_factor=1, **extra):
        ...
        **How to set the scale_factor**:
        ...
        try:
            return FFTNet_(shape, ipsd_net=ipsd_net, nozeromode=self.nozeromode)
        except:
            return FFTNet_(shape, ipsd_net=ipsd_net)
