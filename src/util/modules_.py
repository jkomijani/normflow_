...
from .._normflowcore import np, torch, Module_, ModuleList_
...
class SplineNet_(SplineNet, Module_):
    ...
    def forward(self, x, log0=0):
        ...
        fx, g = spline(x.ravel(), grad=True)  # g is gradient @ x
...
class DistConvertor_(torch.nn.ModuleList, Module_):
    # Do *NOT* write as a child of normflow.ModuleList_; pickle messes up
